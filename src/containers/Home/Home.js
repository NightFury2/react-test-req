...
export default class Home extends React.Component {
  ...
  render() {
    ...
    const loadingAddNotification = this.props.loadingAddNotification ? <CircularProgress size={20} thickness={7}/> : '';
    const loadingCheckAllNotification = this.props.loadingCheckAllNotification ? <CircularProgress size={20} thickness={7}/> : '';
    const loadingRemoveNotification = this.props.loadingRemoveNotification ? <CircularProgress size={20} thickness={7}/> : '';
